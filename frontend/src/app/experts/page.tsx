    ...
    <div className="py-24">
            <div className="grid sm:grid-cols-2 items-start gap-14 p-8 mx-auto max-w-4xl bg-white  rounded-md ">
                <div className="">
                    ...
                    <button id="dropdownActionButton" data-dropdown-toggle="dropdownAction" className="inline-flex items-center mt-5 text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-3 py-1.5 " type="button">
