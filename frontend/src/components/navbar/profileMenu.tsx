  ...
  return (
    <>
      <div
        ...
        className=' flex items-center cursor-pointer  transition mr-[6rem]'
      >
      ...
      {active && (
        <div
          id='user-dropdown'
          className='fixed mt-2 bg-white  divide-gray-100 rounded-lg shadow w-44 '
        >
          ...
          <ul className='py-2 text-sm text-gray-900 ' aria-labelledby='user-menu-button'>
            <li>
              <Link
                href='/wishlist'
                className='block px-4 py-2 text-gray-900 hover:bg-[#058f1a] hover:text-[#fff]'
              >
                Wishlist
              </Link>
            </li>
          ...
          <div className='py-1'>
            <a
              href='#'
              className='block px-4 py-2 text-sm text-gray-900 hover:bg-[#058f1a] hover:text-[#fff]'
            >
              Sign out
            </a>
          </div>
